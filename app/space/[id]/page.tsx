  ...
  const agentSteps = [
    {
      ...
      icon: <Icon icon="solar:lightbulb-bolt-bold-duotone" width="20" height="20" />,
    },
    {
      number: 2,
      name: 'Story Creation',
      icon: <Icon icon="solar:document-text-bold-duotone" width="20" height="20" />,
    },
    {
      number: 3,
      name: 'Email Campaign',
      icon: <Icon icon="solar:letter-bold-duotone" width="20" height="20" />,
    },
    {
      number: 4,
      name: 'RICE Analysis',
    ...
    },
    {
      ...
      icon: <Icon icon="solar:layers-minimalistic-bold-duotone" width="20" height="20" />,
    },
    {
      number: 7,
      name: 'Jira Tickets',
      icon: <Icon icon="solar:checklist-bold-duotone" width="20" height="20" />,
    },
  ];
